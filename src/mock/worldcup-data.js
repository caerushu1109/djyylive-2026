...
export const homeFixtures = [
  {
    ...
    minute: "73'",
    kickoff: "03:00",
    startingAt: "2026-06-20T03:00:00Z",
  ...
  },
  {
    ...
    minute: "",
    kickoff: "已结束",
    startingAt: "2026-06-20T00:00:00Z",
  ...
  },
  {
    ...
    minute: "06:00",
    kickoff: "06:00",
    startingAt: "2026-06-20T06:00:00Z",
  ...
  },
  {
    ...
    minute: "09:00",
    kickoff: "09:00",
    startingAt: "2026-06-20T09:00:00Z",
...
export const standings = [
  {
    group: "A 组",
    rows: [
      { pos: 1, tone: "q1",       flag: "🇺🇸", name: "美国",     p: 3, w: 2, d: 0, l: 1, gf: 5, ga: 3, gd:  2, pts: 6 },
      { pos: 2, tone: "q2",       flag: "🇲🇽", name: "墨西哥",   p: 3, w: 1, d: 1, l: 1, gf: 3, ga: 3, gd:  0, pts: 4 },
      { pos: 3, tone: "out",      flag: "🇯🇲", name: "牙买加",   p: 3, w: 0, d: 1, l: 2, gf: 2, ga: 4, gd: -2, pts: 1 },
      { pos: 4, tone: "out danger", flag: "🇵🇦", name: "巴拿马", p: 3, w: 0, d: 0, l: 3, gf: 1, ga: 6, gd: -5, pts: 0 },
    ],
  },
  {
    group: "B 组",
    rows: [
      { pos: 1, tone: "q1",       flag: "🇧🇷", name: "巴西",     p: 2, w: 2, d: 0, l: 0, gf: 5, ga: 1, gd:  4, pts: 6 },
      { pos: 2, tone: "q2",       flag: "🇵🇹", name: "葡萄牙",   p: 2, w: 1, d: 0, l: 1, gf: 3, ga: 3, gd:  0, pts: 3 },
      { pos: 3, tone: "out",      flag: "🇺🇾", name: "乌拉圭",   p: 2, w: 1, d: 0, l: 1, gf: 2, ga: 2, gd:  0, pts: 3 },
      { pos: 4, tone: "out danger", flag: "🇷🇸", name: "塞尔维亚", p: 2, w: 0, d: 0, l: 2, gf: 1, ga: 5, gd: -4, pts: 0 },
    ],
  },
  {
    group: "C 组",
    rows: [
      { pos: 1, tone: "q1",       flag: "🇫🇷", name: "法国",     p: 2, w: 1, d: 1, l: 0, gf: 3, ga: 1, gd:  2, pts: 4 },
      { pos: 2, tone: "q2",       flag: "🏴",   name: "英格兰",   p: 2, w: 1, d: 1, l: 0, gf: 2, ga: 1, gd:  1, pts: 4 },
      { pos: 3, tone: "out",      flag: "🇳🇱", name: "荷兰",     p: 2, w: 0, d: 1, l: 1, gf: 1, ga: 2, gd: -1, pts: 1 },
      { pos: 4, tone: "out danger", flag: "🇸🇳", name: "塞内加尔", p: 2, w: 0, d: 1, l: 1, gf: 1, ga: 3, gd: -2, pts: 1 },
    ],
  },
  {
    group: "D 组",
    rows: [
      { pos: 1, tone: "q1",       flag: "🇩🇪", name: "德国",     p: 2, w: 1, d: 1, l: 0, gf: 3, ga: 2, gd:  1, pts: 4 },
      { pos: 2, tone: "q2",       flag: "🇯🇵", name: "日本",     p: 2, w: 1, d: 0, l: 1, gf: 2, ga: 2, gd:  0, pts: 3 },
      { pos: 3, tone: "out",      flag: "🇪🇸", name: "西班牙",   p: 2, w: 1, d: 0, l: 1, gf: 2, ga: 2, gd:  0, pts: 3 },
      { pos: 4, tone: "out danger", flag: "🇨🇷", name: "哥斯达黎加", p: 2, w: 0, d: 0, l: 2, gf: 0, ga: 4, gd: -4, pts: 0 },
    ],
  },
];
...
export const historyTournaments = [
  ...
  { year: "1982", host: "🇪🇸 西班牙",       champion: "🏆 🇮🇹 意大利" },
  { year: "1978", host: "🇦🇷 阿根廷",       champion: "🏆 🇦🇷 阿根廷" },
  { year: "1974", host: "🇩🇪 西德",         champion: "🏆 🇩🇪 西德" },
  { year: "1970", host: "🇲🇽 墨西哥",       champion: "🏆 🇧🇷 巴西" },
  { year: "1966", host: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 英格兰", champion: "🏆 🏴󠁧󠁢󠁥󠁮󠁧󠁿 英格兰" },
  { year: "1962", host: "🇨🇱 智利",         champion: "🏆 🇧🇷 巴西" },
  { year: "1958", host: "🇸🇪 瑞典",         champion: "🏆 🇧🇷 巴西" },
  { year: "1954", host: "🇨🇭 瑞士",         champion: "🏆 🇩🇪 西德" },
  { year: "1950", host: "🇧🇷 巴西",         champion: "🏆 🇺🇾 乌拉圭" },
  { year: "1938", host: "🇫🇷 法国",         champion: "🏆 🇮🇹 意大利" },
  { year: "1934", host: "🇮🇹 意大利",       champion: "🏆 🇮🇹 意大利" },
